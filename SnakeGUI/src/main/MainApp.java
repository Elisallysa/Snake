...
public class MainApp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * Desde la MainApp solo se llama a la ventana para seleccionar el tama�o y el nivel.
		 */
		
		new LevelSizeView();

//		do { 
//			if (!level.levelIsSelected) {
//				
//			} else {
//				level.frmSeleccionaLaDificultad.setVisible(false);
//				gameLogic();
//			}
//			
//		} while (!level.levelIsSelected);
//
	}
...
//		while (true)
//
//		{ // por siempre jamás (hasta que nos cierren la ventana) estamos controlando el
//			// juego.
//
...
//						"Se acab�, vaquero, has conseguido " + puntosNum.getText() + " puntos.");
//			}
//
//			// Repintamos
//			tablero.repaint();
